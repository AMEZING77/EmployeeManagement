...
![alt text](assets/141.png)
![alt text](assets/142.png)

### How to Register new user【HttpPost】
1. 两个Manager类的作用 
![alt text](assets/145.png)
2. 实现Register(RegisterViewModel)方法
![alt text](assets/143.png)
1. 注册效果
![alt text](assets/144.png)